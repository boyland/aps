...
The following section provides a solid foundation to the intutive
...
% LocalWords:  Monotonicity irreflexive iff bijection surjective a,b
% LocalWords:  linearize hfill alltt subseteq forall_ sqsubseteq_1
%  LocalWords:  a,b sqsubseteq_2 eqnarray bigcup_i sqsubseteq textrm
%  LocalWords:  stackrel lesssim,S lesssim lnsim ldots forall x,y neq
%  LocalWords:  emptyset
